...
} document.addEventListener('keyup', joinkey); document.addEventListener('keypress', joinkey); document.addEventListener('keydown', joinkey);
...
} document.addEventListener('keyup', enterkey); document.addEventListener('keypress', enterkey); document.addEventListener('keydown', enterkey);
...
} document.addEventListener('keyup', getkey); document.addEventListener('keypress', getkey); document.addEventListener('keydown', getkey);